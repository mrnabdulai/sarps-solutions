...
export default function ExpenditureDetails() {
    ...
    const paramsList = useSelector(state => state.expenditureReducer.expenditure)
                                ...
                                <div>
                                    <div className="flex gap-x-4 items-center">
                                        ...
                                        <p className="text-sm font-medium text-gray-500">
                                            Expenditure added on  created on on <time dateTime={data.createdAt}>{format(Date.parse(data.createdAt), "MMM dd,YYY ")}</time>
                                        </p>
                                    </div>
                                ...
                                <div className="border-t border-gray-200 px-4 py-5 sm:p-0">
                                    <dl className="sm:divide-y sm:divide-gray-200">
                                        <div className="py-4 sm:grid sm:grid-cols-3 sm:gap-4 sm:py-5 sm:px-6">
                                            <dt className="text-sm font-medium text-gray-500">Bill Type</dt>
                                            <dd className="mt-1 text-sm text-gray-900 sm:col-span-2 sm:mt-0">{data.bill_type}</dd>
                                        </div>
