...
function AccountPayable() {
    ...
    const [totalAccountPayable, setTotalAccountPayable] = useState(null)
    ...
    const fetchData = async () => {
        ...
        try {
            setFetching(true)
            setFetchError("")
            const response = await Axios.get("/api/accountPayable/getAccountPayables")
    ...
    return (
                    ...
                    <div class="flex w-full max-w-full flex-col break-words rounded-lg border border-gray-100 bg-white text-gray-600 shadow-lg">
                        <div class="p-3">
                            ...
                            <div class="pt-1 text-right">
                                <p class="text-sm font-light capitalize">Total Account Payable</p>
                                {totalAccountPayable != null ? <h4 class="text-2xl font-semibold tracking-tighter xl:text-2xl">GHC {totalAccountPayable}</h4> :
      ...
      <div class="p-4">
        <p class="font-light"><span class="text-sm font-bold text-red-600">-3% </span>vs last month</p>
                ...
                <AlButton text="Add Account Payable" onClick={() => {
                    navigate('/app/accounts/account-payable/add')
                }} />
                    ...
                    <tbody className="divide-y divide-gray-200 bg-white">
                        {doneFetchingAndHasData() ? (data.map((item, index) => {
                            ...
                            return (<tr key={item.id}>
                                <td className="w-full max-w-0 py-4 pl-4 pr-3 text-sm font-medium text-gray-900 sm:w-auto sm:max-w-none sm:pl-6">
                                    ...
                                    <dl className="font-normal lg:hidden">
                                        ...
                                        <dt className="sr-only sm:hidden">note</dt>
                                        <dd className="mt-1 truncate text-gray-500 sm:hidden">{item.note}</dd>
                                    </dl>
                                </td>
                                ...
                                <td className="py-4 text-right text-sm font-medium ">
                                    <div className='h-full w-full flex items-center justify-center gap-x-4' >
                                        <AlIconButton Icon={EyeIcon} colorClass="text-primary" onClick={() => {
                                            navigate("/app/accounts/account-payable" + item.id)
                                        }} />
                            ...
                            <td colspan={9} className="text-center py-4">
                                ...
                                <h3 className="mt-2 text-sm font-medium text-gray-900">No Accounts Payable created yet</h3>
