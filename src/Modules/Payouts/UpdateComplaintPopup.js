...
export default function UpdateComplaintPopup({ onUpdateConfirm, open, setOpen , selectedStatus, setSelectedStatus}) {
  ...
  return (
    <Transition.Root show={open} as={Fragment}>
      ...
      <div className="px-4 py-5 sm:p-6">
        <h3 className="text-lg font-medium leading-6 text-gray-900">Update payout status</h3>
        <div className="mt-2 max-w-xl text-sm text-gray-500">
          <p>Select new status for this payout</p>
        </div>
