...
/*
  ...
  ```
*/
export default function AddAccountReceivable() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await Axios.post("/api/accountReceivable/addAccountReceivable", data);
            console.log(response);
            setIsSubmitting(false);

            navigate("/app/accounts/account-receivable")
        }
        catch (err) {
            console.log(err);
            setIsSubmitting(false);
